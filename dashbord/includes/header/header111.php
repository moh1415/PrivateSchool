...
<!--                                <li><a href="#">Class info</a></li>-->
                                ...
                                <li><a href="select_child_course.php">Courses</a></li>
                                 <li><a href="select_child_syllabus.php">view syllabus</a></li>
                                    <li><a href="select_child_assignment.php">view Assignment</a></li>
                                    <li><a href="select_child_learning.php">view Learning Resource</a></li>
                                <li><a href="select_child_note.php">view Class Notes</a></li>
                                <li><a href="select_child_schedule.php">Time Table</a></li>
