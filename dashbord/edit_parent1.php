...
include  "includes/header.php";
        ...
        if (isset($_POST['update']))
        {
            ...
            if (empty($fullname)or empty($phone)or empty($work_number)or empty($address)or empty($password)or empty($student_id))
            {
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <div class="alert alert-danger" role="alert">
                                                        ...
                                                        <div class="alert alert-success" role="alert">
                                                            <strong>Well done!</strong> You successfully update the parent <a href="list_parents.php" class="alert-link"> back to parents list</a>.
