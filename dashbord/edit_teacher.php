                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <div class="alert alert-danger" role="alert">
                                                        ...
                                                        <div class="alert alert-success" role="alert">
                                                            <strong>Well done!</strong> You successfully update the teacher <?php if ($_SESSION['role']=='admin'){echo '<a href="list_teachers.php" class="alert-link"> back to teacher list</a>.';} ?>
