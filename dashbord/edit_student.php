                                            ...
                                            <div class="card-body">
                                                <form action="" method="post">
                                                    ...
                                                    <div class="alert alert-danger" role="alert">
                                                        ...
                                                        <div class="alert alert-success" role="alert">
                                                            <strong>Well done!</strong> You successfully update the student <?php if ($_SESSION['role']=='admin') {echo '<a href="list_students.php" class="alert-link"> back to student list</a>.';} ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" maxlength="10" type="date" name="year" value="<?php echo $year1?>" id="example-text-input">
                                                        <?php }?>
