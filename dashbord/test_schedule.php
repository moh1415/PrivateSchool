                                        ...
                                        <div class="col-12 mt-1">
                                            <div class="card-body">
                                                <form action="" method="post">
                                                    ...
                                                    {
                                                $id123 = $_SESSION['student_id'];

                                                        
                                                         $query1 = "select * from student where s_id = $id123";
                                                                    $list_student1 =mysqli_query($con,$query1);
                                                                    $row1 = mysqli_fetch_assoc($list_student1);
                                                        $class12 = $row1['class'];
                                                        
                                                        
                                                        

                                                                    $query = "select * from schedule where sche_class = $class12";
                                                                                                            ...
                                                                                                            if (isset($_GET['id']))
{
    ...
    //$course_name =$_GET['course_name'];
                                                ...
                                                $id123 = $_SESSION['parent_id'];

                                                        
                                                         $query1 = "select * from student where s_id = $student_id";
                                                                    $list_student1 =mysqli_query($con,$query1);
                                                                    $row1 = mysqli_fetch_assoc($list_student1);
                                                        $class12 = $row1['class'];
