                          ...
                          if (isset($_GET['id']))
{
    ...
    //$course_name =$_GET['course_name'];
        ...
        if (isset($_POST['submit']))
        {
           ...
           // $i = 1;
            if (empty($id1))
            {
                header("location: view_syllabus.php?message=00");
            }
            else {
                $query = "Select * from syllabus where c_id =$id1";
 ...
 header("location: view_syllabus.php?message=$id1");
                    
                } else {

                    header("location: view_syllabus.php?message=0");
    ...
    <div class="main-content">
        ...
        <div class="main-content-inner">
            <div class="row">
                                            ...
                                            <div class="card-body">
                                                <form action="" method="post">
                                                    ...
                                                    <div class="alert alert-danger" role="alert">
                                                        <strong>Wrong!</strong> the syllabus not exists.
                                                    </div>
              ...
              $query = "Select * from syllabus where c_id =$id2";
                $row = mysqli_query($con, $query);
                    $vw = mysqli_fetch_assoc($row);
