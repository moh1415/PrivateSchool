            ...
            <form>
                ...
                <div class="login-form-body">
                    <div class="form-gp">
                        ...
                        <input name="fullanme" type="text" id="exampleInputName1">
                        <i class="ti-user"></i>
                    </div>
                    <div class="form-gp">
                        <label for="exampleInputEmail1">ID</label>
                        <input name="id" maxlength="10" type="text" id="exampleInputEmail1">
                        <i class="ti-anchor"></i>
                    </div>
                    <div class="form-gp">
                        <label for="exampleInputEmail1">Phone</label>
                        <input name="phone" maxlength="10" type="text" id="exampleInputEmail1">
                        <i class="fa fa-phone"></i>
                    </div>
                    <div class="form-gp">
                        <label for="exampleInputEmail1">Work Phone</label>
                        <input name="work_phone" maxlength="10" type="text" id="exampleInputEmail1">
                        <i class="fa fa-phone"></i>
                    </div>
                    <div class="form-gp">
                        <label for="exampleInputEmail1">Address</label>
                        <input name="address" type="text" id="exampleInputEmail1">
