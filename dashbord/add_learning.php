...
include  "includes/header.php";
    ...
    else
    {
        ...
        {
                     $query33 = "Select * from learning where c_id = $c_id ";
                $select_course33 = mysqli_query($con,$query33);
                $row33 = mysqli_fetch_assoc($select_course33);
            
            if($row33){
                
                header("location:add_learning.php?s=0");
            }
...
else 
{
    $status = 0;
            ...
            $noftit_con="New Learning Resource added";
            ...
            foreach ($class_id as $value)
            {
                notification($title,$value,$noftit_con,$t_id);
                    ...
                    header("location:add_learning.php?s=$status");
                                ...
                                <div class="invoice-head">
                                    <div class="row">
                                        <div class="iv-left col-6">
                                            <span>Add New Learning Resource</span>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <form action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="alert alert-danger" role="alert">
                                                        <strong>Wrong!</strong> The course resource already exists.
                                                    </div>
                                                        <?php } else if (isset($_GET['s']) and $_GET["s"]==1){?>
                                                        <div class="alert alert-success" role="alert">
                                                            <strong>Well done!</strong> You successfully add the course learning resource.
                                                        </div>
                                                        <?php } ?>
<!--
